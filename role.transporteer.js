	    ...
	    if(creep.store[RESOURCE_ENERGY] < 50) {
            ...
            if(0) {
                ...
                var targets = creep.pos.findClosestByPath(FIND_STRUCTURES, {
                    filter: (i) => (i.id == '5e5fc193a8bd372dc8b835b5' || i.id == '5e5f6c33ea09a695a34fb7ed' ) && i.store[RESOURCE_ENERGY] > 450
                });
                if(targets) {
            ...
            if (targets == null) {
                targets = creep.pos.findClosestByPath(FIND_STRUCTURES, {
                    filter: (i) => (i.id == '5e606de0e4c9ff6ef3b1dca5' || i.id == '5e5ff70811a570efde5aa774') && i.store[RESOURCE_ENERGY] < 1600
                });
            }
            if (targets == null) {
                targets = creep.pos.findClosestByPath(FIND_STRUCTURES, {
