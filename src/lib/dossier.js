...
sortedLastIndex.lib.vram.markCritical(SEGMENT_DOSSIER)
...
class Dossier{
    constructor(){
        let intel=sortedLastIndex.lib.vram.getData(SEGMENT_DOSSIER)
    ...
    _flushIntel(){
        ...
        sortedLastIndex.lib.vram.markDirty(SEGMENT_DOSSIER)
    }
}
